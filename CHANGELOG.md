...
* chore(deps): bump golang.org/x/sync from 0.20.0 to 0.21.0 by @dependabot[bot] in https://github.com/coffeebeats/gdenv/pull/413
* chore(deps): bump googleapis/release-please-action from 4.4.0 to 5.0.0 by @dependabot[bot] in https://github.com/coffeebeats/gdenv/pull/405
* chore(deps): bump codecov/codecov-action from 6.0.0 to 6.0.1 by @dependabot[bot] in https://github.com/coffeebeats/gdenv/pull/411
* chore(deps): bump goreleaser/goreleaser-action from 7.0.0 to 7.2.2 by @dependabot[bot] in https://github.com/coffeebeats/gdenv/pull/408
* chore(deps): bump github/codeql-action from 4.35.1 to 4.36.0 by @dependabot[bot] in https://github.com/coffeebeats/gdenv/pull/410
* chore(deps): bump tj-actions/changed-files from 47.0.5 to 47.0.6 by @dependabot[bot] in https://github.com/coffeebeats/gdenv/pull/407
* chore(deps): bump golang.org/x/net from 0.43.0 to 0.55.0 in the go_modules group across 1 directory by @dependabot[bot] in https://github.com/coffeebeats/gdenv/pull/414
* chore(deps): bump golang.org/x/mod from 0.34.0 to 0.40.0 by @dependabot[bot] in https://github.com/coffeebeats/gdenv/pull/412
* fix(ci): resolve lint and coverage-upload CI failures by @coffeebeats in https://github.com/coffeebeats/gdenv/pull/415
...
* chore(deps): bump github.com/go-resty/resty/v2 from 2.16.2 to 2.16.3 by @dependabot in https://github.com/coffeebeats/gdenv/pull/295
* chore(deps): bump github.com/go-resty/resty/v2 from 2.16.3 to 2.16.4 by @dependabot in https://github.com/coffeebeats/gdenv/pull/296
* chore(deps): bump github.com/go-resty/resty/v2 from 2.16.4 to 2.16.5 by @dependabot in https://github.com/coffeebeats/gdenv/pull/297
* chore(deps): bump golang.org/x/sync from 0.10.0 to 0.11.0 by @dependabot in https://github.com/coffeebeats/gdenv/pull/298
* chore(deps): bump golang.org/x/mod from 0.22.0 to 0.23.0 by @dependabot in https://github.com/coffeebeats/gdenv/pull/299
* fix: address project linter errors by @coffeebeats in https://github.com/coffeebeats/gdenv/pull/301
* fix(godot): use correct build label when forming GitHub asset URL by @coffeebeats in https://github.com/coffeebeats/gdenv/pull/300
* chore: remove usage of flags for code coverage by @coffeebeats in https://github.com/coffeebeats/gdenv/pull/302
* chore(download): disable TuxFamily mirror, as it's redundant with GitHub by @coffeebeats in https://github.com/coffeebeats/gdenv/pull/303
...
* feat(ci): pre-build `arm64`on `linux` binaries by @coffeebeats in https://github.com/coffeebeats/gdenv/pull/223
