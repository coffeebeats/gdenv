...
# https://github.com/coffeebeats/gdenv/blob/v0.6.11/docs/installation.md # x-release-please-version
...
.NOTES
  Version:        0.6.11 # x-release-please-version
...
Param (
  ...
  [String] $Version = "v0.6.11" # x-release-please-version
)
